...
#########################################################################
# eclipse_make_ino.sh - Script to convert Arduino C++ to Arduino format #
# 									#
# This component is part of XDAQ v1.0 Virtual Appliance 		# 
# Copyright (C) 2015 by Alessandro Faraci                               #
#                                                                       #
# eclipse_make_ino.sh is free software: you can redistribute it and/or 	#
# modify it under the terms of the GNU Lesser General Public License 	#
# as published by the Free Software Foundation, either version 3 of 	#
# the License, or (at your option) any later version.                   #
#                                                                       #
# eclipse_make_ino.sh is distributed in the hope that it will be useful #
# but WITHOUT ANY WARRANTY; without even the implied warranty of        #
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the         #
# GNU Lesser General Public License for more details.                   #
#                                                                       #
# You should have received a copy of the GNU Lesser General Public      #
# License along with eclipse_make_ino.sh				#
# If not, see <http://www.gnu.org/licenses/> 				#
#########################################################################

if [ -z "$1" ];
then
	echo -e "Usage: ./eclipse_make_ino.sh <full name of cpp module to convert>\n"
	exit
fi
...
then
	...
	then
		echo -e "Convertion completed. \nCreated Arduino project available at $DSTFOLDER/$MODULE/"
	else
