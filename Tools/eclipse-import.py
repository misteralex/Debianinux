...
#########################################################################
# eclipse_import.py - Script to import older version of Arduino C++     #
# project Eclipse based.						#
# 									#
# This component is part of XDAQ v1.0 Virtual Appliance 		# 
# Copyright (C) 2015 by Alessandro Faraci                               #
#                                                                       #
# eclipse_import.py is free software: you can redistribute it and/or 	#
# modify it under the terms of the GNU Lesser General Public License 	#
# as published by the Free Software Foundation, either version 3 of 	#
# the License, or (at your option) any later version.                   #
#                                                                       #
# eclipse_import.py is distributed in the hope that it will be useful   #
# but WITHOUT ANY WARRANTY; without even the implied warranty of        #
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the         #
# GNU Lesser General Public License for more details.                   #
#                                                                       #
# You should have received a copy of the GNU Lesser General Public      #
# License along with eclipse_import.py					#
...
if len(sys.argv) < 2:
   ...
   print "arg1: this is full path of the folder where is the project to import."
   print
   exit(0)
